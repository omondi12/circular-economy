...
@php
    ...
    $icons = [
        ...
        'landmark' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-18 0h18M3 9v.75A.75.75 0 0 0 3.75 10.5h16.5a.75.75 0 0 0 .75-.75V9M4.5 21h15" />',
    ][$icon] ?? '';
@endphp
